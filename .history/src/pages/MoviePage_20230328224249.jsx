    ...
    <div className="page-container w-full flex flex-col gap-5 mt-5">
      <div className="flex">
        <div className="w-full">
          <input
            type="text"
            className="w-full p-3 bg-slate-700 outline-none focus:border focus:border-white transition-all duration-200 ease-linear"
            name=""
            id=""
            placeholder="Type here to search ..."
          />
        </div>
        <button className="bg-primary py-2 px-4 outline-none flex-shrink-0">
