...
function MovieCredits() {
  const { movieId } = useParams();
  const { data, error } = useSWR(tmdbApi.getMoviesCredits(movieId), fetcher);
...
function MovieTrailer() {
  const { movieId } = useParams();
  const { data, error } = useSWR(tmdbApi.getMoviesTrailer(movieId), fetcher);
...
function MovieSimilar() {
  const { movieId } = useParams();
  const { data, error } = useSWR(tmdbApi.getMoviesSimilar(movieId), fetcher);
