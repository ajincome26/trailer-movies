        ...
        <div className="rounded-xl w-full h-full relative overflow-hidden">
          ...
          <div className="absolute text-white bottom-5 left-5">
            ...
            <div className="flex items-center gap-x-3">
              <button className="px-10 py-3 bg-primary rounded-md flex items-center gap-x-12 font-semibold">
                Watch
                <BsFillPlayCircleFill />
              </button>
              <button className="p-4 bg-opacity-90 bg-[#4a4242] rounded-md font-semibold">
                <AiOutlinePlus size={18} fontWeight={"bold"} />
              </button>
            </div>
          </div>
        </div>
